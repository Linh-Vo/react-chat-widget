...
import { setBadgeCount, markAllMessagesRead, toggleChat } from "@actions";
const closeIcon = require("../../../../../../../assets/ic-down.svg") as string;
  ...
  return (
    <div id="messages" className="rcw-messages-container" ref={messageRef}>
      ...
      <button
        ...
        className="rcw-messages-close-button"
      >
